...
class App{
  ...
  APPS = [
    ...
    { id:'timing', title:'Setting Timing Output', desc:'Output Finish Good OTB', icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3.5 2"/></svg>', ready:true },
  ...
  switchApp(appId){
    ...
    if(appId==='doubleseam') this.applyDoubleSeamHeader();
      ...
      this.dom.largeTitleSub.textContent = 'Setting Timing FG · PRESENTED BY FATHUR';
